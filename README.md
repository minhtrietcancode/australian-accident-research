...
For detailed analysis, please refer to the [report](Road Accident Severity Analysis.pdf). This README file will only provide a brief overview of the project, and which file is responsible for which part of the analysis.
